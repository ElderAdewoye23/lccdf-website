    ...
    >
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <motion.h2
          ...
          className="text-3xl md:text-4xl lg:text-5xl font-heading text-primary mb-8 text-center"
        >
          Who We Are
        </motion.h2>
        ...
        <motion.p
          ...
          className="text-gray-700 text-lg md:text-xl mb-12 text-center max-w-3xl mx-auto leading-relaxed"
        >
          Living Care Community Development Foundation (LCCDF) is a registered
          Nigerian NGO dedicated to promoting health, education, and economic
          empowerment in underserved communities since 2007.
        </motion.p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-12">
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed">
              To provide basic health care, educational and environmental
              services in society through continuous capacity building, advocacy
              of leaders and sensitization of the society.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed">
              Building a society where quality health care, educational and
              environmental services are accessible to all.
            </p>
          </motion.div>
        </div>
